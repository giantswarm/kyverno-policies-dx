...
cat <<EOF | kind create cluster --name "${KIND_CLUSTER_NAME}" --image="kindest/node:v1.30.13@sha256:cf819926d6f5ba996f7489fa18a38156f952f5dd172395da7d83f734190e95da" --config=-
kind: Cluster
